...
if (!process.env.HIDE_TRANSCRIPT_WARNINGS && !isDJSv14)
    console.log('[WARN] discord-html-transcripts will no longer support v13 in a later release, please update to v14.');
    ...
    if (opts.saveImages) {
        await Promise.all(messagesArray
            ...
            for (const attachment of attachments) {
                ...
                if (!staticTypes.IMAGE_EXTS.includes((attachment.name ?? 'unknown.png')
                    .split('.')
                    .pop()?.toLowerCase() ?? ""))
                    continue;
